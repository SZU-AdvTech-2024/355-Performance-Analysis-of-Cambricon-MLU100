/**
 * @file util/mutex_queue.hpp
 * @brief 使用mutex和condition_variable实现的线程安全队列
 */

#ifndef MULTICARD_MUTEX_QUEUE_H
#define MULTICARD_MUTEX_QUEUE_H
